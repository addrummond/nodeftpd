...
FtpConnection.prototype._command_MLSD = function (commandArg, detailed) {
    /*
        ...
        self._whenDataReady(function(pasvconn) {
            ...
            for (var i = 0; i < fileInfos.length; ++i) {
                ...
                if (! detailed) {
                    ...
                    line += (02 & s.mode) ? 'w' : '-';
                    line += (01 & s.mode) ? 'x' : '-';
                    line += " 1 " + (fileInfo.uname === null ? "root" : fileInfo.uname) + " " +
                            (fileInfo.gname === null ? "root" : fileInfo.gname) + " ";
